...
export default function RoomPage({
  ...
  return <GameScreen state={state} me={me} roomKey={roomKey} />;
}
...
function LobbyScreen({
  ...
  const setTimer = (turnSeconds: number) => {
    fetch(`/api/rooms/${roomKey}/settings`, {
      method: "POST",
  ...
  const ready = async () => {
    ...
    setError(null);
    const res = await fetch(`/api/rooms/${roomKey}/ready`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
function GameScreen({
  ...
  const submit = async () => {
    ...
    setError(null);
    const res = await fetch(`/api/rooms/${roomKey}/guess`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
